...
if &background == "dark"
  ...
  " https:g/github.com/kien/ctrlp.vim
  hi CtrlPMatch       guifg=#000000 guibg=#f8cf00 gui=none

  " https:g/github.com/scrooloose/nerdtree
  ...
  " https:g/github.com/majutsushi/tagbar
  ...
  " https:g/github.com/davidhalter/jedi-vim
  ...
  " https:g/github.com/tomtom/quickfixsigns_vim
  ...
  if &t_Co > 255
    ...
    " https:g/github.com/tomasr/molokai/issues/22
    set background=dark
  endif
else
  """""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""
